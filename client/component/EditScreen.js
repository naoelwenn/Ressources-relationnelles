import { StyleSheet, Text, View, FlatList, Image, TouchableOpacity, TextInput,Dimensions  } from 'react-native';
...
export default function EditScreen({ navigation, route }) {
    ...
    const handleSave = async () => {
        ...
        //navigation.navigate("Ma ressource", {refresh: true}) // retour au detailScreen
